...
impl From<bind::SDL_PixelFormatEnum> for PackedPixelLayout {
    fn from(raw: bind::SDL_PixelFormatEnum) -> Self {
        ...
        match (raw >> 16) & 0xf {
            bind::SDL_PACKEDLAYOUT_332 => _332,
            bind::SDL_PACKEDLAYOUT_4444 => _4444,
            bind::SDL_PACKEDLAYOUT_1555 => _1555,
            bind::SDL_PACKEDLAYOUT_5551 => _5551,
            bind::SDL_PACKEDLAYOUT_565 => _565,
            bind::SDL_PACKEDLAYOUT_8888 => _8888,
            bind::SDL_PACKEDLAYOUT_2101010 => _2101010,
            bind::SDL_PACKEDLAYOUT_1010102 => _1010102,
            _ => unreachable!(),
        }
    }
}
